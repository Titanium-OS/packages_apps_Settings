...
public class SystemUpdatePreferenceController extends BasePreferenceController {
    ...
    private static final String OTA_BUILD_TYPE_PROP = "ro.titanium.buildtype";
    private static final String DEVICE_NAME = "ro.titanium.device";
    private static final String OTA_APP_PACKAGE = "com.titanium.ota";
    ...
    public CharSequence getSummary() {
        CharSequence summary = mContext.getString(R.string.titanium_ota_summary);
        return summary;
    }
